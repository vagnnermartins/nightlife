...
public class BaladaAdapter extends ArrayAdapter<ParseObject> {
    ...
    public class BaladaViewHolder{
        ...
        public BaladaViewHolder(View view){
            this.nome = (TextView) view.findViewById(R.id.item_balada_nome);
            this.telefone = (TextView) view.findViewById(R.id.item_balada_telefone);
            this.endereco = (TextView) view.findViewById(R.id.item_balada_endereco);
            this.distancia = (TextView) view.findViewById(R.id.item_balada_distancia);
        }
    }
}
